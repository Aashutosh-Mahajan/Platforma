...
export default function RestaurantCard({ restaurant }) {
  ...
  return (
    <Link href={`/restaurant/${restaurant?.id}`} className="group block h-full">
      <article className="h-full overflow-hidden rounded-2xl border border-[#F0E0E0] bg-white shadow-[0_8px_20px_rgba(27,27,27,0.06)] transition-all duration-200 group-hover:-translate-y-0.5 group-hover:shadow-[0_16px_34px_rgba(183,18,42,0.12)]">
